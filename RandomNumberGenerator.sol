...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Cliff lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == cliffLottery, "Only CliffLottery");
    ...
    /**
     * @notice Set the address for the CliffLottery
     * @param _cliffLottery: address of the Cliff lottery
     */
    function setLotteryAddress(address _cliffLottery) external onlyOwner {
        cliffLottery = _cliffLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICliffRaffle(cliffLottery).viewCurrentLotteryId();
    }
}
